...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { icon: Users, label: "Our Clients", href: "", subItems: [
    ...
    { icon: Layers, label: "App", href: "", subItems: [
      { label: "Calander", href: "/calander" },
      { label: "Chat App", href: "/chat-app" },
    ]  },

    { icon: Box, label: "UI Components", href: "/ui-components" },
  ];

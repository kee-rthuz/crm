...
const TopPerformerCard = ({ name, username, percentage }) => (
  <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm flex flex-col items-center">
    ...
    <p className="text-lg sm:text-xl md:text-2xl font-bold mt-1 sm:mt-2">{percentage}%</p>
  </div>
);
...
const InterviewList = ({ interviews }) => {
  return (
    <div className="flex justify-end">
      <div className="w-full md:w-[468px] bg-white rounded-lg shadow-md overflow-hidden">
  ...
  return (
    <div className="p-2 sm:p-4 md:p-6 bg-gray-100 min-h-screen">
      ...
      <div className="mt-16 sm:mt-20 md:mt-24 md:ml-0 lg:ml-72">
        ...
        <div className="mt-6 bg-[#e6b3c3] py-6 sm:py-8 md:py-10">
          <h2 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-center">Top Performers</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4 px-2 sm:px-4">
            {performers.map((performer, index) => (
              <TopPerformerCard key={index} {...performer} />
            ))}
          </div>
        </div>
      </div>

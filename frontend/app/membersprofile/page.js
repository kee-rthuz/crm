        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            ...
            <ul className="space-y-4">
              {['Pixel Wibes', 'Crest Coder', 'Morning Wibe', 'FebiFlue'].map((company, index) => (
                <li key={index} className="flex items-center space-x-3">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white ${['bg-green-500', 'bg-red-500', 'bg-purple-500', 'bg-blue-500'][index]}`}>
                    {company.split(' ').map(word => word[0]).join('')}
                  </div>
                  <div>
                    <p className="font-medium">{company}</p>
                    <p className="text-sm text-gray-600">
                      {index === 0 ? 'Jan 2016 - Present (5 years 2 months)' :
                       index === 1 ? 'Dec 2015 - 2016 (1 years)' :
                       index === 2 ? 'Nov 2014 - 2015 (1 years)' :
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            ...
            <ul className="space-y-2">
              {[
                ...
                { label: 'Passport No.', value: '5468953210' },
                { label: 'Emergency Contact', value: '7468953210' },
              ].map((item, index) => (

...
function ProjectCard({ project, onAddMember, onClick, onEdit, onStatusChange, className }) {
...
function EmployeeInvitationDialog({ onClose }) {
  ...
  const employees = [
    { name: 'Lucas Baker', email: 'lucas.baker@gmail.com', role: 'Members', avatar: '👨‍💼', resend: true },
    { name: 'Una Coleman', email: 'una.coleman@gmail.com', role: 'Members', avatar: '👩‍💼' },
  ];
